<?php /**
 * @file
 * Contains \Drupal\registration\Plugin\Field\FieldFormatter\RegistrationLink.
 */
 ...
 * )
 */
class RegistrationLink extends FormatterBase {

  /**
   * @FIXME
   * Move all logic relating to the registration_link formatter into this
